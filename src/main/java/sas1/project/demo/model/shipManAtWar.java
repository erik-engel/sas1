...
public class shipManAtWar extends Ship {
    ...
    public shipManAtWar(boolean canTurn, Direction direction, String position, int sailors, int maxSailors, int rowsOfGuns, int gunsPrRow, int gunsSailorsNeeded, int selectedAmmo, int sailsHP, int sails, int maxSails, int sailsSailorsNeeded, int hullHP, int maxHullHP, int speed, int maxSpeed, int maxSpeedChange, int numberOfTurns, int sailors1, int maxSailors1, int rowsOfGuns1, int gunsPrRow1, int gunsSailorsNeeded1, int sailsHP1, int sails1, int maxSails1, int sailsSailorsNeeded1, int hullHP1, int maxHullHP1, int speed1, int maxSpeed1, int maxSpeedChange1, int numberOfTurns1) {
